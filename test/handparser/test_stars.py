...
class TestHandWithFlopOnly:
    ...
    @pytest.mark.parametrize(('attribute', 'expected_value'),
        ...
        ('hero', HandHistoryPlayer(name='W2lkm2n', stack=3000, seat=5, combo=Combo('AcJh'))),
        ('players', [
...
class TestAllinPreflopHand:
    ...
    @pytest.mark.parametrize(('attribute', 'expected_value'),
        ...
        ('max_players', 9),
        ('button', HandHistoryPlayer(name='W2lkm2n', stack=11815, seat=2, combo=Combo('JdJs'))),
        ('hero', HandHistoryPlayer(name='W2lkm2n', stack=11815, seat=2, combo=Combo('JdJs'))),
        ('players', [
