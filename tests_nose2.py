...
class BaseTest(unittest.TestCase):
    ...
    #        doesn't work with instance methods
            #yield self.check_attribute, self, attribute, result

    #def test_body(self):
    #    for attribute, result in self.body_results.items():
    #        self.hand = PokerStarsHand(self.hh)
    #        yield self.check_attribute, self, attribute, result


class TestHand1(BaseTest):
    hh = """PokerStars Hand #105024000105: Tournament #797469411, $3.19+$0.31 USD Hold'em No Limit - Level I (10/20) - 2013/10/04 19:53:27 CET [2013/10/04 13:53:27 ET]
...
Seat 9: STBIJUJA folded before Flop (didn't bet)"""
    ...
    body_results = {'table_name': '797469411 15',
                     'max_players': 9,
                     'button_seat': 1,
                     'button': 'flettl2',
                     'hero': 'W2lkm2n',
    ...
    def test_attribute(self, attr, res):
        assert_equal(getattr(self.hand, attr), res)

#class TestHand2(BaseTest):
#    hh = """PokerStars Hand #105034215446: Tournament #797536898, $3.19+$0.31 USD Hold'em No Limit - Level XI (400/800) - 2013/10/04 23:22:20 CET [2013/10/04 17:22:20 ET]
...
#                 }
#    body_results = {'table_name': '797536898 9',
#                    'max_players': 9,
#                    'button_seat': 2,
#                    'button': 'W2lkm2n',
#                    'hero': 'W2lkm2n',
